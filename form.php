...
<html lang="en">
	<head>
		...
		<title>Import Data Absensi Fingerprint</title>
	...
	<body>
		...
		<nav class="navbar navbar-inverse" role="navigation">
			<div class="container-fluid">
				<div class="navbar-header">
					<a class="navbar-brand" href="#" style="color: white;"><b>Import Data Absensi Fingerprint</b></a>
				</div>
		...
		<div style="padding: 0 15px;">
			...
			<a href="menu.php" class="btn btn-danger pull-right">
